...
# MetaCyc
dGMetaCyc <- read.csv("~/Dropbox/model_analysis/Data/All_reactions_of_MetaCyc.csv")
...
# Equilibrator
EquilibratorpH7 <- read.csv("~/Dropbox/model_analysis/Data/kegg_reactions_CC_ph7.0.csv")
...
write.csv2(Potato,file = "potato_reversibility")# separado por ; Se debe abrir asi en libre office

#write.table(Potato, file = "potato_reversibility", sep = ",") no sirvio, pero revisatr que no sirve para este caso
